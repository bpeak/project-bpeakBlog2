...
const mapDispatchToProps = (dispatch) => ({
    receivedPost : (payload) => { dispatch(postsActionCreators.receivedPost(payload)) },
    receivedPosts : (payload) => { dispatch(postsActionCreators.receivedPosts(payload)) }
})
...
class PostEditorContainer extends Component {
    ...
    _uploadPostImgFile = (imgFile) => {
        ...
        return callApi('/api/admin/postImgFile', {
            method : "POST",
            headers : {
    ...
    _createPost = (post, isPublished) => {
        ...
        return callApi('/api/admin/posts', {
            method : "POST",
            headers : {
                Authorization : `Bearer ${userState.token}`,
            },
    ...
    _updatePost = (post) => {
        ...
        const { userState } = this.props
        return callApi(`/api/admin/posts/${post_id}`, {
            method : "PATCH",
            headers : {
                Authorization : `Bearer ${userState.token}`,
            },
